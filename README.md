...
**核心特性**：
- ⚛️ **原子图标悬浮球** - 墨黑色渐变，支持拖拽和置顶
- 📊 **两级展开面板** - 单击简洁视图，按钮全展开
- 💰 **实时Token统计** - 自动追踪 Claude Code 和 Cursor 使用量
- 🔔 **智能告警** - 根据安全风险改变图标状态（正常/警告/严重）
- 🌍 **跨平台支持** - macOS、Windows、Linux 全支持

**使用说明**：
- **悬浮球** - 点击查看简洁面板（今日消耗、月度消耗、安全评分）
- **展开详情** - 点击"查看详细信息"查看完整Token分解
- **拖拽定位** - 可随意拖动到屏幕任意位置
- **托盘菜单** - 右键托盘图标打开/退出应用

详细配置：[Desktop Widget 使用指南](docs/DESKTOP_WIDGET.md)
